...
//    private static final String REFERRED_BY = "referredBy";
    private static final String PACKAGE_NAME = "dev.moutamid.myvideoeditor";
//    private static final String PAID_STATUS = "paidStatus";
    ...
    public void storeLong(Context context, String name, long object) {
        sharedPreferences = context.getSharedPreferences(PACKAGE_NAME, Context.MODE_PRIVATE);
        sharedPreferences.edit().putLong(name, object).apply();
    }

    public long getStoredLong(Context context, String name) {
        sharedPreferences = context.getSharedPreferences(PACKAGE_NAME, Context.MODE_PRIVATE);
